...
public class ArmController {
    ...
    public void manualMove(Position currentPosition) {
        ...
        System.out.println("Options: base, joint1, joint2, wristX, claw");
    ...
    public Position getNewPosition(Scanner scanner) {
        ...
        // Create new position
        Position desiredPosition = new Position(base, joint1, joint2, wristX, claw);
    ...
    public Position getShortestMiddlePosition(Position currentPosition, Position desiredPosition) {
        int middleBase = (currentPosition.getBaseServo() + desiredPosition.getBaseServo()) / 2;
        int middleJoint1 = (currentPosition.getJoint1Servo() + desiredPosition.getJoint1Servo()) / 2;
        int middleJoint2 = (currentPosition.getJoint2Servo() + desiredPosition.getJoint2Servo()) / 2;
        int middleWristX = (currentPosition.getWristXServo() + desiredPosition.getWristXServo()) / 2;
        int middleClaw = (currentPosition.getClawServo() + desiredPosition.getClawServo()) / 2;
        Position shortestMiddlePosition = new Position(middleBase, middleJoint1, middleJoint2, middleWristX, middleClaw);
        return shortestMiddlePosition; 
    }
