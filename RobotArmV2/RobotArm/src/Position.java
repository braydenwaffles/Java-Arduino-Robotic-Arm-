public class Position {
    ...
    int joint2Servo; //joint 2
    int wristXServo; //wrist x
    int wristYServo; //wrist y
    int clawServo; //claw

    //constructor
    public Position(int baseServo, int joint1Servo, int joint2Servo, int wristXServo, int wristYServo, int clawServo) {
        this.baseServo = baseServo;
        this.joint1Servo = joint1Servo;
        this.joint2Servo = joint2Servo;
        this.wristXServo = wristXServo;
        this.wristYServo = wristYServo;
    ...
    //wrist y
    public int getWristYServo() {
        return wristYServo;
    }
    public void setWristYServo(int wristYServo) {
        this.wristYServo = wristYServo;
    }
    ...
    public String toString() {
        return "Base(Bottom): " + baseServo + " Joint 1: " + joint1Servo + " Joint 2: " + joint2Servo + " Wrist X: " + wristXServo + " Wrist Y: " + wristYServo + " Claw: " + clawServo;
    }
